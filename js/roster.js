    ...
    if (typeof profile != 'undefined') {
      ...
      member
        ...
        .html(
            ...
            '<td class="align-middle"><a target="_blank" href="https://destinytracker.com/d2/profile/psn/' + memberId + '/' + name + '">View Stats</a></td>' // DTR Profile 
            '<td class="align-middle"><a target="_blank" href="https://www.bungie.net/en/Profile/254/' + name + '">View Profile</a></td>' // Bungie Profile 
        );
