        ...
        if (typeof profile != 'undefined') {
            ...
            member
                ...
                .html(
                    ...
                    '<td class="align-middle text-center">'+('<a target="_blank" href="https://www.wastedondestiny.com/2_' + destinyId + '"><img src="img/clock.png" style="width: 20px; height:20px"></a>')+'</td>' // Wasted Time
