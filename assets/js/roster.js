...
twitch["Savagely-Gentle"] = "intemerata_";
    ...
    for (var i = 0; i < rsp.length; i++) {
        ...
        if (typeof profile != "undefined") {
            ...
            member.attr({
                ...
                "</td>" + '<td class="align-middle text-center"><a target="_blank" href="https://destinytracker.com/d2/profile/psn/' + name + '">Stats</a></td>' + '<td class="align-middle text-center"><a target="_blank" href="https://raid.report/ps/' + name + '">Clears</a></td>');
